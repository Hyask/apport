...
class T(unittest.TestCase):
    ...
    def test_add_proc_info(self):
        ...
        self.assertIn(pr['ExecutablePath'], ['/bin/cat', '/usr/bin/cat'])
        self.assertNotIn('InterpreterPath', pr)
...
''' % os.getenv('PYTHON', 'python3')).encode('ascii'))
    ...
    def test_check_interpreted(self):
        ...
        try:
            ...
            pr._check_interpreted()
            self.assertIn(pr['ExecutablePath'], ['/bin/zgrep', '/usr/bin/zgrep'])
            ...
            pr._check_interpreted()
            self.assertEqual(pr['InterpreterPath'], '/usr/bin/python')
            self.assertIn(pr['ExecutablePath'], ['/bin/bash', '/usr/bin/bash'])
...
'''
    ...
    def test_extrapath_preferred(self):
        ...
        self.assertIn(bin_true, ['/bin/true', '/usr/bin/true'])
